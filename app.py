...
def fetch_cricket_scores():
    ...
    headers = {
        ...
        "X-RapidAPI-Key": "9e855a6f96msh84f0b13236f14b2p117c52jsn24dd00e327bf"  
    }
...
def fetch_upcoming_matches():
    ...
    headers = {
        "X-RapidAPI-Host": "cricbuzz-cricket.p.rapidapi.com",
        "X-RapidAPI-Key": "7b30264054msh2c93c3e93a742f0p19835fjsn60d9ea86cbb3"  # Replace with your RapidAPI key
    }
    #
    response = requests.get(url, headers=headers)
    upcoming_matches = []
